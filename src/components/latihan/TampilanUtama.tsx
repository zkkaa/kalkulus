  ...
  return (
    ...
    >
      ...
      <div className="sticky z-10 flex flex-col items-center gap-6 max-w-3xl w-full">
        ...
        >
          Uji kemampuanmu dengan ribuan soal kalkulus yang dirancang untuk mengasah kemampuan kalkulus. Dari limit dasar hingga integral kompleks, jadilah sang ahli SIGMA.
        </p>
